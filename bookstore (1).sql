...
CREATE TABLE `uniforms` (
  ...
  PRIMARY KEY (`product_id`),
  KEY `category_id` (`category_id`),
  CONSTRAINT `uniforms_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Boon Elijah', NULL, 'BSCPE', 202090032, '$2y$10$1D2GS15FLMnrZbUSZzrIRO6T9fJDvkKF2EEjsRgzuvTmmqd5eE.Fu', '2026-04-18 16:50:46'),
(2, 'Admin', NULL, 'admin', 202040032, '$2y$10$ra5fEoRTa.1.84mTe0og5.09tQosEh3g4wRuo7xvOg8i7uUTbyoYq', '2026-04-20 15:00:52');
