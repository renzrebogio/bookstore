<div id="addToUniformModal" class="modal-container" style="display:none;">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Add New Uniform</h2>
        </div>
        
        <form action="../../include/addToUniformModalFunction.php" method="POST" enctype="multipart/form-data" id="addToUniformModalForm">
            ...
            <div class="modal-footer">
                <button type="button" class="btn-cancel" onclick="closeUniformModal()">Cancel</button>
