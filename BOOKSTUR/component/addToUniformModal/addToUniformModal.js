document
  .querySelector("#addToUniformModalForm")
...
function openUniformModal() {
  const modal = document.getElementById("addToUniformModal");
  if (modal) {
    modal.style.display = "flex";
  } else {
    console.error("Modal element 'addToUniformModal' not found in the DOM.");
  }
}
