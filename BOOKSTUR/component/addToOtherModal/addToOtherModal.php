<div id="addToOtherModal" class="modal-container" style="display:none; ">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Add New Items</h2>
        </div>
        
        <form  action="../../include/addToOtherModalFunction.php" method="POST" enctype="multipart/form-data" id="addToOtherModalForm">
            ...
            <div class="modal-footer">
                <button type="button" class="btn-cancel" onclick="closeOtherModal()">Cancel</button>
